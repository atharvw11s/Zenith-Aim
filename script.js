...
const SCENARIO_DB = {
  aimlabs: {
    tracking: [
      ...
      { name: 'VT Longtrack', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Lowtrack', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Hightrack', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Glidetrack', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Air AIO', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Close Long Strafes', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Close Fast Strafes', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'MICROSTARTRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'REACTIVETRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'ARCTRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'STRAFETRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'CIRCLETRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'FREETRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'MOTIONTRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'SPHERETRACK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Controlsphere Platinum', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Smoothsphere Easy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'berryTS Smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'mpTS Smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Smoothpill Silver', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Smoothpill Iron', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Smoothpill Bronze', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
    flicking: [
      /* BEGINNER */
      ...
      { name: 'VT Popshot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 10 Sphere Hipfire Extra Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 1w1ts SmallBlinks', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'GRIDSHOT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'SPIDERSHOT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'SCATTERSHOT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'SIXSHOT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'MOTIONSHOT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'LINETRACE', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'MULTILINETRACE', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'BURSTFLICK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WALLPEEK', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Angleshot Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Curveshot Multi Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Blinkshot Novice', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Rainshot Novice', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Boltshot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Adjust Click', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Adjust Click Micro', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT MicroPace', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Flowshot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Vibeshot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Surgeshot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Axishot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
    switching: [
      /* BEGINNER */
      ...
      { name: 'VT 1w4ts', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT ww3t TE', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT ww4ts', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Regenspheres', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Controltrack Blink', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Dodgeswitch', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Tile Spheres 90 Dynamic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 1w4ts Extra Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Pokeball', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 1w2t TE', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 1w4ts 30% larger', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 1w4ts 30% smaller', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT 10 Sphere Hipfire Extra Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Pokeball Frenzy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'VT Threeshot Widow Micro', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
  },
  ...
  kovaaks: {
    tracking: [
      ...
      { name: 'Air', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Ground Plaza', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Plaza High Ground', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Plaza Low Ground', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Close Long Strafes Invincible', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'T1 Drop Punish 1 Side', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Vertical Fast Strafes', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'RexStrafesCata', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Air Angelic 4', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Closerange Tracking Training', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'B180TI', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'B360TI', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Sparky Air Angelic 4', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Centering I', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Centering II', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi legacy tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Leica air basic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Leica air intermediate', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Leica air advanced', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Trippez smooth reactivity 1', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Trippez smooth reactivity 2', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Trippez smooth reactivity 3', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Trippez smooth reactivity 4', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi horizontal tracking + movement', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi precision tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi flying things track and switch', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi close combat tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Eeriecold tracking v3', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev general reactive', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev reactive smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev close range reactive smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Ridd reactive smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Torje tracking intermediate', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Torje tracking advanced', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Trippez Stop and Go', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Voltaic reactivity', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Easy General Tracking West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev Small Tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Semi-Precise Tracking West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '1HTMDPE', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Tracking Perfection', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Faster Tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WP 10 Min Precise Tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WPV Horizontal Predictable Half', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Tracking Val', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'COD Easy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
    flicking: [
      /* BEGINNER */
      ...
      { name: 'Target Acquisition Flick', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '5 Sphere Hipfire Extra Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'patTargetSwitch Small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Hachi1wall', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Floating heads timing 400%', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Tile Frenzy 180 Strafing', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '1wall5targets pasu', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'pasu reload small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Target Switching 360', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      ...
      { name: 'West Proter Speed Flicks', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'West Proter Precise Flicks', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Short Dynamic West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Micro Adjustments 30 West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Micro Adjustments Fast West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'n0tified Dynamic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WPV Dynamic Vert', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Precise Extremism', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WP 10 Min Precise Tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'hnA1', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Speedy ZexRow', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'n0tified Dynamic Long', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Val Peeks West Proter YT', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Val Track West Proter Easy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Val Dynamic 15 min Easy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '15 Minute Micros West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '15 Minute Reactivity', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '50 Minutes Of Precise Flicking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Precise 15', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Normal Pacing', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Easy General Flicking West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Easy General Dynamic West Proter', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev Small Dynamic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Precise Extremism Psev Edition', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Bigman Cartoon\'s Speedy Micros', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Speed Flicks Easy', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Speedy Dynamic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Accel Aim Bot', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Reactions', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Static Smooth', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Precise Movements', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'WPV Horizontal Predictable Half', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
    switching: [
      /* BEGINNER */
      ...
      { name: 'Tile Frenzy 180 Strafing 300% Tracking', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'McCoy 1v1', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '1wall9000targets', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'voxTargetSwitch', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'xenTargetSwitch', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'patCircleSwitch', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'kinTSSkeet', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'kinTS Voltaic', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: '1wall6Air Invincible', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi legacy switching', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi static switch small', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi static switch speed', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lapu4 switching 1', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lapu4 switching 2', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lapu4 switching 3', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lapu4 large angle switching', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Jab complete', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi Yin', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Krascsi Yang', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lapu4 complete', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Lorys end', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Ridd dense reps alpha', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Roa complete', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Dynamic 30 Min', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
      { name: 'Psev Evasive', difficulty: ['beginner','intermediate','advanced'], duration: 5, sets: 3, tip: 'Focus on consistency over speed.' },
    ],
  },
}
/* ═══════════════════════════════════════════════════════════════
